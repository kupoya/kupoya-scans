...
$(document).ready(function () {
	$(".showhide-account").each(
			function (intIndex) {
				$(this).bind(
						"click",
						function() {
							//alert('testing index' + intIndex);
					        $("#dropdown_"+intIndex).slideToggle("fast");
					        $(this).toggleClass("active");
						}
				);
			}
...
$(document).bind("click", function (e) {
    if (e.target.id != $(".showhide-*").attr("class")) $(".account-*").slideUp();
});
*/
/*
$(document).ready(function () {
			...
			function (intIndex) {
				$(this).bind(
						...
						function(e) {
							...
							if (e.target.id != $(this).attr("class"))
								$("#dropdown_"+intIndex).slideUp();
						}
				);
			}
	);
