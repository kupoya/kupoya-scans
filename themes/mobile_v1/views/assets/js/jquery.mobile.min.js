...
x,B),v&&(clearTimeout(v),v=0),p=s=!1,d=f(b).touches[0],y=d.pageX,u=d.pageY,h("vmouseover",b,c),h("vmousedown",b,c)}function o(a){s||(p||h("vmousecancel",a,e(a.target)),p=!0,g())}function q(b){if(!s){var c=f(b).touches[0],d=p,i=a.vmouse.moveDistanceThreshold;p=p||Math.abs(c.pageX-y)>i||Math.abs(c.pageY-u)>i;flags=e(b.target);p&&!d&&h("vmousecancel",b,flags);h("vmousemove",b,flags);g()}}function l(a){if(!s){s=!0;var b=e(a.target),c;h("vmouseup",a,b);!p&&h("vclick",a,b)&&(c=f(a).changedTouches[0],A.push({touchID:B,
x:c.clientX,y:c.clientY}),w=!0);h("vmouseout",a,b);p=!1;g()}}function n(b){var b=a.data(b,m),c;if(b)for(c in b)if(b[c])return!0;return!1}function i(){}function r(b){var c=b.substr(1);return{setup:function(){n(this)||a.data(this,m,{});a.data(this,m)[b]=!0;t[b]=(t[b]||0)+1;t[b]===1&&C.bind(c,j);a(this).bind(c,i);if(E)t.touchstart=(t.touchstart||0)+1,t.touchstart===1&&C.bind("touchstart",k).bind("touchend",l).bind("touchmove",q).bind("scroll",o)},teardown:function(){--t[b];t[b]||C.unbind(c,j);E&&(--t.touchstart,
t.touchstart||C.unbind("touchstart",k).unbind("touchmove",q).unbind("touchend",l).unbind("scroll",o));var d=a(this),f=a.data(this,m);f&&(f[b]=!1);d.unbind(c,i);n(this)||d.removeData(m)}}}var m="virtualMouseBindings",x="virtualTouchID",d="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),z="clientX clientY pageX pageY screenX screenY".split(" "),t={},v=0,y=0,u=0,p=!1,A=[],w=!1,s=!1,E=a.support.eventCapture,C=a(c),F=1,B=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var D=0;D<d.length;D++)a.event.special[d[D]]=r(d[D]);E&&c.addEventListener("click",function(b){var c=A.length,d=b.target,f,s,e,i,g;if(c){f=b.clientX;s=b.clientY;threshold=a.vmouse.clickDistanceThreshold;for(e=d;e;){for(i=0;i<c;i++)if(g=A[i],e===d&&Math.abs(g.x-f)<threshold&&Math.abs(g.y-s)<threshold||a.data(e,x)===g.touchID){b.preventDefault();b.stopPropagation();return}e=e.parentNode}}},!0)})(jQuery,window,document);
...
e;l=setTimeout(g,a.fn[f].delay)}var h={},l,j=b(),i=function(a){return a},r=i,m=i;h.start=function(){l||g()};h.stop=function(){l&&clearTimeout(l);l=c};a.browser.msie&&!k&&function(){var c,d;h.start=function(){if(!c)d=(d=a.fn[f].src)&&d+b(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){d||r(b());g()}).attr("src",d||"javascript:0").insertAfter("body")[0].contentWindow,e.onpropertychange=function(){try{if(event.propertyName==="title")c.document.title=e.title}catch(a){}}};h.stop=
i;m=function(){return b(c.location.href)};r=function(b,d){var g=c.document,i=a.fn[f].domain;if(b!==d)g.title=e.title,g.open(),i&&g.write('<script>document.domain="'+i+'"<\/script>'),g.close(),c.location.hash=b}}();return h}()})(jQuery,this);(function(a){a.widget("mobile.page",a.mobile.widget,{options:{theme:"c",domCache:!1},_create:function(){var a=this.element,c=this.options;this._trigger("beforeCreate")!==!1&&a.addClass("ui-page ui-body-"+c.theme)}})})(jQuery);
...
(function(a,d){function c(a){var b=a.jqmData("lastClicked");b&&b.length?b.focus():(b=a.find(".ui-title:eq(0)"),b.length?b.focus():a.find(x).eq(0).focus())}function b(b){r&&(!r.closest(".ui-page-active").length||b)&&r.removeClass(a.mobile.activeBtnClass);r=null}function f(){t=!1;z.length>0&&a.mobile.changePage.apply(null,z.pop())}function e(b,d,f,e){var i=a.support.scrollTop?q.scrollTop():!0,h=b.data("lastScroll")||a.mobile.defaultHomeScroll,j=g();i&&window.scrollTo(0,a.mobile.defaultHomeScroll);h<
a.mobile.minScrollBack&&(h=0);d&&(d.height(j+i).jqmData("lastScroll",i).jqmData("lastClicked",r),d.data("page")._trigger("beforehide",null,{nextPage:b}));b.height(j+h).data("page")._trigger("beforeshow",null,{prevPage:d||a("")});a.mobile.hidePageLoadingMsg();f=(a.mobile.transitionHandlers[f||"none"]||a.mobile.defaultTransitionHandler)(f,e,b,d);f.done(function(){b.height("");h?(a.mobile.silentScroll(h),a(document).one("silentscroll",function(){c(b)})):c(b);d&&d.height("").data("page")._trigger("hide",
...
a(b).closest(".ui-page").jqmData("url"),c=p.hrefNoHash;if(!b||!i.isPath(b))b=c;return i.makeUrlAbsolute(b,c)}var q=a(window),l=a("html"),n=a("head"),i={urlParseRE:/^(((([^:\/#\?]+:)?(?:\/\/((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?]+)(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,parseUrl:function(b){if(a.type(b)==="object")return b;var b=i.urlParseRE.exec(b),c;b&&(c={href:b[0]||"",hrefNoHash:b[1]||"",hrefNoSearch:b[2]||"",domain:b[3]||"",protocol:b[4]||"",authority:b[5]||
...
a("<div></div>"),v=d.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,o=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp(".*(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*").test(d)&&RegExp.$1&&o.test(RegExp.$1)&&RegExp.$1&&(b=m=i.getFilePath(RegExp.$1));w&&w.set(m);k.get(0).innerHTML=d;g=k.find(":jqmData(role='page'), :jqmData(role='dialog')").first();g.length||(g=a("<div data-"+a.mobile.ns+"role='page'>"+d.split(/<\/?body[^>]*>/gmi)[1]+"</div>"));v&&!g.jqmData("title")&&g.jqmData("title",
v);if(!a.support.dynamicBaseTag){var r=i.get(m);g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,r+c)})}g.attr("data-"+a.mobile.ns+"url",i.convertUrlToDataUrl(m)).appendTo(e.pageContainer);g.one("pagecreate",function(){g.data("page").options.domCache||g.bind("pagehide.remove",
function(){a(this).remove()})});j(g,e.role);l.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=e.pageContainer.children(":jqmData(url='"+t+"')"));e.showLoadMsg&&(clearTimeout(n),a.mobile.hidePageLoadingMsg());f.resolve(l,c,g,h)},error:function(){w&&w.set(i.get());e.showLoadMsg&&(clearTimeout(n),a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:q.scrollTop()+100}).appendTo(e.pageContainer).delay(800).fadeOut(400,
function(){a(this).remove()}));f.reject(l,c)}});return f.promise()};a.mobile.loadPage.defaults={type:"get",data:d,reloadPage:!1,role:d,showLoadMsg:!1,pageContainer:d,loadMsgDelay:50};a.mobile.changePage=function(c,g){if(typeof g!=="object"){var h=null;if(typeof c==="object"&&c.url&&c.type)h={type:c.type,data:c.data,forcePageLoad:!0},c=c.url;var n=arguments.length;if(n>1){var k=["transition","reverse","changeHash","fromHashChange"],o;for(o=1;o<n;o++){var r=arguments[o];typeof r!=="undefined"&&(h=h||
{},h[k[o-1]]=r)}}if(h)return a.mobile.changePage(c,h)}if(t)z.unshift(arguments);else{t=!0;var p=a.extend({},a.mobile.changePage.defaults,g);p.pageContainer=p.pageContainer||a.mobile.pageContainer;if(typeof c=="string")a.mobile.loadPage(c,p).done(function(b,c,d,f){t=!1;c.duplicateCachedPage=f;a.mobile.changePage(d,c)}).fail(function(){t=!1;b(!0);f();p.pageContainer.trigger("changepagefailed")});else{var u=p.pageContainer,h=a.mobile.activePage,k=n=c.jqmData("url");i.getFilePath(n);o=m.getActive();var r=
m.activeIndex===0,q=0,y=document.title,x=p.role==="dialog"||c.jqmData("role")==="dialog";u.trigger("beforechangepage");if(h&&h[0]===c[0])t=!1,u.trigger("changepage");else{j(c,p.role);p.fromHashChange&&m.directHashChange({currentUrl:n,isBack:function(){q=-1},isForward:function(){q=1}});try{a(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur()}catch(w){}x&&o&&(n=o.url+v);if(p.changeHash!==!1&&n)m.ignoreNextHashChange=!0,i.set(n);var A=c.jqmData("title")||c.children(":jqmData(role='header')").find(".ui-title").text();
A&&y==document.title&&(y=A);q||m.addNew(n,p.transition,y,k);document.title=m.getActive().title;a.mobile.activePage=c;p.transition=p.transition||(q&&!r?o.transition:d)||(x?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);p.reverse=p.reverse||q<0;e(c,h,p.transition,p.reverse).done(function(){b();p.duplicateCachedPage&&p.duplicateCachedPage.remove();l.removeClass("ui-mobile-rendering");f();u.trigger("changepage")})}}}};a.mobile.changePage.defaults={transition:d,reverse:!1,changeHash:!0,
...
direction:c.jqmData("direction"),reloadPage:!0}),b.preventDefault())}});a(document).bind("vclick",function(b){if((b=k(b.target))&&i.parseUrl(b.getAttribute("href")||"#").hash!=="#")a(b).closest(".ui-btn").not(".ui-disabled").addClass(a.mobile.activeBtnClass),a("."+a.mobile.activePageClass+" .ui-btn").not(b).blur()});a(document).bind("click",function(c){var f=k(c.target);if(f){var e=a(f),g=function(){window.setTimeout(function(){b(!0)},200)};if(e.is(":jqmData(rel='back')"))return window.history.back(),
!1;if(a.mobile.ajaxEnabled){var h=o(e),f=i.makeUrlAbsolute(e.attr("href")||"#",h);if(f.search("#")!=-1)if(f=f.replace(/[^#]*#/,""))f=i.isPath(f)?i.makeUrlAbsolute(f,h):i.makeUrlAbsolute("#"+f,u.hrefNoHash);else{c.preventDefault();return}var h=e.is("[rel='external']")||e.is(":jqmData(ajax='false')")||e.is("[target]"),l=a.mobile.allowCrossDomainPages&&u.protocol==="file:"&&f.search(/^https?:/)!=-1,h=h||i.isExternal(f)&&!l;r=e.closest(".ui-btn");h?g():(g=e.jqmData("transition"),h=(h=e.jqmData("direction"))&&
h==="reverse"||e.jqmData("back"),e=e.attr("data-"+a.mobile.ns+"rel")||d,a.mobile.changePage(f,{transition:g,reverse:h,role:e}),c.preventDefault())}else g()}});a(".ui-page").live("pageshow.prefetch",function(){var b=[];a(this).find("a:jqmData(prefetch)").each(function(){var c=a(this).attr("href");c&&a.inArray(c,b)===-1&&(b.push(c),a.mobile.loadPage(c))})});q.bind("hashchange",function(){var b=i.stripHash(location.hash),c=a.mobile.urlHistory.stack.length===0?"none":d;if(!a.mobile.hashListeningEnabled||
m.ignoreNextHashChange)m.ignoreNextHashChange=!1;else{if(m.stack.length>1&&b.indexOf(v)>-1)if(a.mobile.activePage.is(".ui-dialog")){var f=function(){b=a.mobile.urlHistory.getActive().pageUrl};m.directHashChange({currentUrl:b,isBack:f,isForward:f})}else{m.directHashChange({currentUrl:b,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}b?(b=typeof b==="string"&&!i.isPath(b)?"#"+b:b,a.mobile.changePage(b,{transition:c,changeHash:!1,fromHashChange:!0})):
...
b=b.last().addClass("ui-corner-bottom"),b.add(b.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").addClass("ui-corner-bl"))},refresh:function(c){this.parentPage=this.element.closest(".ui-page");this._createSubPages();var b=this.options,d=this.element,e=d.jqmData("dividertheme")||b.dividerTheme,g=d.jqmData("splittheme"),h=d.jqmData("spliticon"),j=d.children("li"),k=a.support.cssPseudoElement||!a.nodeName(d[0],"ol")?0:1,o,q,l,n,i;k&&d.find(".ui-li-dec").remove();
for(var r=0,m=j.length;r<m;r++){o=j.eq(r);q="ui-li";if(c||!o.hasClass("ui-li"))l=o.jqmData("theme")||b.theme,n=o.children("a"),n.length?(i=o.jqmData("icon"),o.buttonMarkup({wrapperEls:"div",shadow:!1,corners:!1,iconpos:"right",icon:n.length>1||i===!1?!1:i||"arrow-r",theme:l}),n.first().addClass("ui-link-inherit"),n.length>1&&(q+=" ui-li-has-alt",n=n.last(),i=g||n.jqmData("theme")||b.splitTheme,n.appendTo(o).attr("title",n.text()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:!1,corners:!1,
theme:l,icon:!1,iconpos:!1}).find(".ui-btn-inner").append(a("<span />").buttonMarkup({shadow:!0,corners:!0,theme:i,iconpos:"notext",icon:h||n.jqmData("icon")||b.splitIcon})))):o.jqmData("role")==="list-divider"?(q+=" ui-li-divider ui-btn ui-bar-"+e,o.attr("role","heading"),k&&(k=1)):q+=" ui-li-static ui-body-"+l;k&&q.indexOf("ui-li-divider")<0&&(l=o.is(".ui-li-static:first")?o:o.find(".ui-link-inherit"),l.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+k++ +". </span>"));o.add(o.children(".ui-btn-inner")).addClass(q);
c||this._itemApply(d,o)}this._refreshCorners()},_idStringEscape:function(a){return a.replace(/[^a-zA-Z0-9]/g,"-")},_createSubPages:function(){var c=this.element,b=c.closest(".ui-page"),f=b.jqmData("url"),e=f||b[0][a.expando],g=c.attr("id"),h=this.options,j="data-"+a.mobile.ns,k=this,o=b.find(":jqmData(role='footer')").jqmData("id"),q;typeof d[e]==="undefined"&&(d[e]=-1);g=g||++d[e];a(c.find("li>ul, li>ol").toArray().reverse()).each(function(b){var d=a(this),e=d.attr("id")||g+"-"+b,b=d.parent(),k=
a(d.prevAll().toArray().reverse()),k=k.length?k:a("<span>"+a.trim(b.contents()[0].nodeValue)+"</span>"),m=k.first().text(),e=(f||"")+"&"+a.mobile.subPageUrlKey+"="+e,x=d.jqmData("theme")||h.theme,z=d.jqmData("counttheme")||c.jqmData("counttheme")||h.countTheme;q=!0;d.detach().wrap("<div "+j+"role='page' "+j+"url='"+e+"' "+j+"theme='"+x+"' "+j+"count-theme='"+z+"'><div "+j+"role='content'></div></div>").parent().before("<div "+j+"role='header' "+j+"theme='"+h.headerTheme+"'><div class='ui-title'>"+
m+"</div></div>").after(o?a("<div "+j+"role='footer' "+j+"id='"+o+"'>"):"").parent().appendTo(a.mobile.pageContainer).page();d=b.find("a:first");d.length||(d=a("<a/>").html(k||m).prependTo(b.empty()));d.attr("href","#"+e)}).listview();q&&b.data("page").options.domCache===!1&&b.unbind("pagehide.remove").bind("pagehide.remove",function(c,d){var e=d.nextPage;d.nextPage&&(e=e.jqmData("url"),e.indexOf(f+"&"+a.mobile.subPageUrlKey)!==0&&(k.childPages().remove(),b.remove()))})},childPages:function(){var c=
this.parentPage.jqmData("url");return a(":jqmData(url^='"+c+"&"+a.mobile.subPageUrlKey+"')")}});a(document).bind("pagecreate create",function(c){a(a.mobile.listview.prototype.options.initSelector,c.target).listview()})})(jQuery);
...
"",j=b.attr("id"),k=j+"-label",j=a("[for='"+j+"']").attr("id",k),o=function(){return h=="input"?parseFloat(b.val()):b[0].selectedIndex},q=h=="input"?parseFloat(b.attr("min")):0,l=h=="input"?parseFloat(b.attr("max")):b.find("option").length-1,n=window.parseFloat(b.attr("step")||1),i=a("<div class='ui-slider "+f+" ui-btn-down-"+g+" ui-btn-corner-all' role='application'></div>"),r=a("<a href='#' class='ui-slider-handle'></a>").appendTo(i).buttonMarkup({corners:!0,theme:e,shadow:!0}).attr({role:"slider",
"aria-valuemin":q,"aria-valuemax":l,"aria-valuenow":o(),"aria-valuetext":o(),title:o(),"aria-labelledby":k});a.extend(this,{slider:i,handle:r,dragging:!1,beforeStart:null});h=="select"&&(i.wrapInner("<div class='ui-slider-inneroffset'></div>"),b.find("option"),b.find("option").each(function(b){var c=!b?"b":"a",d=!b?"right":"left",b=!b?" ui-btn-down-"+g:" ui-btn-active";a("<div class='ui-slider-labelbg ui-slider-labelbg-"+c+b+" ui-btn-corner-"+d+"'></div>").prependTo(i);a("<span class='ui-slider-label ui-slider-label-"+
c+b+" ui-btn-corner-"+d+"' role='img'>"+a(this).text()+"</span>").prependTo(r)}));j.addClass("ui-slider");b.addClass(h==="input"?"ui-slider-input":"ui-slider-switch").change(function(){c.refresh(o(),!0)}).keyup(function(){c.refresh(o(),!0,!0)}).blur(function(){c.refresh(o(),!0)});a(document).bind("vmousemove",function(a){if(c.dragging)return c.refresh(a),!1});i.bind("vmousedown",function(a){c.dragging=!0;if(h==="select")c.beforeStart=b[0].selectedIndex;c.refresh(a);return!1});i.add(document).bind("vmouseup",
function(){if(c.dragging){c.dragging=!1;if(h==="select"){c.beforeStart===b[0].selectedIndex&&c.refresh(!c.beforeStart?1:0);var a=o(),a=Math.round(a/(l-q)*100);r.addClass("ui-slider-handle-snapping").css("left",a+"%").animationComplete(function(){r.removeClass("ui-slider-handle-snapping")})}return!1}});i.insertAfter(b);this.handle.bind("vmousedown",function(){a(this).focus()}).bind("vclick",!1);this.handle.bind("keydown",function(b){var d=o();if(!c.options.disabled){switch(b.keyCode){case a.mobile.keyCode.HOME:case a.mobile.keyCode.END:case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:if(b.preventDefault(),
!c._keySliding)c._keySliding=!0,a(this).addClass("ui-state-active")}switch(b.keyCode){case a.mobile.keyCode.HOME:c.refresh(q);break;case a.mobile.keyCode.END:c.refresh(l);break;case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:c.refresh(d+n);break;case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:c.refresh(d-n)}}}).keyup(function(){if(c._keySliding)c._keySliding=!1,a(this).removeClass("ui-state-active")});this.refresh(d,d,!0)},refresh:function(a,
...
(function(a){var d=function(c){var b=c.selectID,d=c.label,e=c.select.closest(".ui-page"),g=a("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(e),h=c.select.find("option"),j=c.isMultiple=c.select[0].multiple,k=b+"-button",o=b+"-menu",q=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+c.options.menuPageTheme+"'><div data-"+a.mobile.ns+"role='header'><div class='ui-title'>"+d.text()+"</div></div><div data-"+a.mobile.ns+"role='content'></div></div>").appendTo(a.mobile.pageContainer).page(),
l=a("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-"+c.options.overlayTheme+" "+a.mobile.defaultDialogTransition}).insertAfter(g),n=a("<ul>",{"class":"ui-selectmenu-list",id:o,role:"listbox","aria-labelledby":k}).attr("data-"+a.mobile.ns+"theme",c.options.theme).appendTo(l),i=a("<div>",{"class":"ui-header ui-bar-"+c.options.theme}).prependTo(l),r=a("<h1>",{"class":"ui-title"}).appendTo(i),m=a("<a>",{text:c.options.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+
a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(i).buttonMarkup(),x=q.find(".ui-content"),z=q.find(".ui-header a");a.extend(c,{select:c.select,selectID:b,buttonId:k,menuId:o,thisPage:e,menuPage:q,label:d,screen:g,selectOptions:h,isMultiple:j,theme:c.options.theme,listbox:l,list:n,header:i,headerTitle:r,headerClose:m,menuPageContent:x,menuPageClose:z,placeholder:"",build:function(){var b=this;b.refresh();b.select.attr("tabindex","-1").focus(function(){a(this).blur();
